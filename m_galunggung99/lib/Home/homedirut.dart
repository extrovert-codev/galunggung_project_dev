...
import 'package:m_galunggung99/Listing/listlistingmenu.dart';
...
import 'package:m_galunggung99/Attendance/employeeattendance.dart';
...
class HomeDirut extends StatefulWidget {
  @override
  _HomeDirutState createState() => _HomeDirutState();
}

class _HomeDirutState extends State<HomeDirut> {
  bool isLoading;
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(
                                      child: btnMenu(
                                          ...
                                          ApproveListing())),
                                  Expanded(
                                      child: btnMenu('Daftar Listingan',
                                          Icons.list, ListListingMenu()))
                                ])),
                            Container(
                                height: 90,
                                decoration: BoxDecoration(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(
                                      child: btnMenu(
                                          'Logout', Icons.exit_to_app, Login()))
                                ]))
                            // Body
                          ])
                        ]))));
