...
class ListListingPendingSaya extends StatefulWidget {
  @override
  _ListListingPendingSayaState createState() => _ListListingPendingSayaState();
}

class _ListListingPendingSayaState extends State<ListListingPendingSaya> {
  bool isLoading;
  ...
  Future refreshData() async {
    ...
    ListListingSayaModel.execAPIGetListingAllEmp('0', _gScript.myEmpID)
        .then((value) {
      setState(() {
        if (value != null) {
