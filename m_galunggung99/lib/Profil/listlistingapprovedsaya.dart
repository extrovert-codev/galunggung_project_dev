...
class ListListingApprovedSaya extends StatefulWidget {
  @override
  _ListListingApprovedSayaState createState() =>
      _ListListingApprovedSayaState();
}

class _ListListingApprovedSayaState extends State<ListListingApprovedSaya> {
  bool isLoading;
  ...
  Future refreshData() async {
    ...
    ListListingSayaModel.execAPIGetListingAllEmp('2', _gScript.myEmpID)
        .then((value) {
      setState(() {
        if (value != null) {
