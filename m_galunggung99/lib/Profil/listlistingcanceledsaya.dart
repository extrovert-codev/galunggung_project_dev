...
class ListListingCanceledSaya extends StatefulWidget {
  @override
  _ListListingCanceledSayaState createState() =>
      _ListListingCanceledSayaState();
}

class _ListListingCanceledSayaState extends State<ListListingCanceledSaya> {
  bool isLoading;
  ...
  Future refreshData() async {
    ...
    ListListingSayaModel.execAPIGetListingAllEmp('3', _gScript.myEmpID)
        .then((value) {
      setState(() {
        if (value != null) {
