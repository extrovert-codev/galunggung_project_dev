...
class ListListingCanceled extends StatefulWidget {
  @override
  _ListListingCanceledState createState() => _ListListingCanceledState();
}

class _ListListingCanceledState extends State<ListListingCanceled> {
  ...
  Future refreshData() async {
    ...
    ListListingModel.execAPIGetListingAllEmp('3').then((value) {
      setState(() {
        if (value != null) {
