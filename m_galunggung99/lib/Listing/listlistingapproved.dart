...
class ListListingApproved extends StatefulWidget {
  @override
  _ListListingApprovedState createState() => _ListListingApprovedState();
}

class _ListListingApprovedState extends State<ListListingApproved> {
  ...
  Future refreshData() async {
    ...
    ListListingModel.execAPIGetListingAllEmp('2').then((value) {
      setState(() {
        if (value != null) {
