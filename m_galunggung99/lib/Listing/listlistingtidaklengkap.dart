...
class ListListingTidakLengkap extends StatefulWidget {
  @override
  _ListListingTidakLengkapState createState() =>
      _ListListingTidakLengkapState();
}

class _ListListingTidakLengkapState extends State<ListListingTidakLengkap> {
  ...
  Future refreshData() async {
    ...
    ListListingModel.execAPIGetListingAllEmp('1').then((value) {
      setState(() {
        if (value != null) {
